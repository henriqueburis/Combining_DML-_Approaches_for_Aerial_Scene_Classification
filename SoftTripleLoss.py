...
parser = argparse.ArgumentParser(description="Train SoftTripleLoss")
...
seed = "SoftTripleLoss_"+args.name
print('seed==>',seed)
...
loss_func = losses.SoftTripleLoss(num_classes, embedding_size, centers_per_class=10, la=20, gamma=0.1, margin=0.01)
