...
parser = argparse.ArgumentParser(description="Train SignalToNoiseRatioContrastiveLoss.py")
...
seed = "SignalToNoiseRatioContrastiveLoss_"+args.name
print('seed==>',seed)
...
loss_func = losses.SignalToNoiseRatioContrastiveLoss(pos_margin=0, neg_margin=1)
